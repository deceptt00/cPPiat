...
class PmergeMe 
{
    public:
        ...
        typename T::iterator next_it(typename T::iterator it, int n);
		std::vector<size_t> jacobsthalOrder(size_t pendSize);
		void appendBlock(T &result, typename T::iterator it, int depth);
		T insert(std::vector<typename T::iterator>& pend,
        ...
        // T &getcontainer{};
		static bool compare(typename T::iterator it1, typename T::iterator it2) { return (*it1 < *it2); }
